...
gulp.task('build', function() {
  sequence('clean:dist', ['sass', 'scripts', 'assets', 'images', 'fonts'], ['templates', 'templates:views']);
});
...
gulp.task('deploy:ghpages', function() {
  sequence(['clean:tmp', 'clean:publish', 'clean:dist'], ['sass', 'scripts', 'assets', 'images', 'fonts'], ['templates', 'templates:views'], 'ghpages');
});
